"use client";
import { columns } from "@/components/table/order/admin/column";
...
export function OrderTable() {
    ...
    const { data, isPending, error, isError, refetch } = api.admin.order.filteredOrders.useQuery(
        {
        ...
        {
            enabled: filterAdminOrdersSchema.safeParse({
                pageLimit: { page, limit },
                amount,
                orderDate,
                search: debouncedSearchTerm.trim() === '' ? undefined : debouncedSearchTerm,
