...
import { editCourseSchemaBackEnd, filterCourseSchemaWithInfiniteScroll } from "@/lib/schema/course";
...
export const courseRouter = router({
    ...
    editCourse: adminProcedure.input(editCourseSchemaBackEnd).mutation(async ({ input, ctx }) => {
        const prisma = ctx.prisma;
        try {
